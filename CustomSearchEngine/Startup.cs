...
using CustomSearchEngine.Services.Google;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient(provider =>
            {
                ...
                {
                   // [Constants.SearchEngines.Bing] = provider.GetRequiredService<BingSearchEngine>(),
                    [Constant.Google] = provider.GetRequiredService<GoogleEngine>()
                };
            });
        }
